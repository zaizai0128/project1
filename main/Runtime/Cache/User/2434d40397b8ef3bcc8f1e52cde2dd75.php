...
<body>
  ...
  <div class="navbar-inner">
	...
	<ul class="nav nav-list">
		...
		<li <?php if(vip == 'ext'): ?>class="active"<?php endif; ?>><a href="<?php echo U('/user/center/index');?>">补充信息</a></li>
		<li <?php if(vip == 'true_info'): ?>class="active"<?php endif; ?>><a href="<?php echo U('/user/center/trueInfo');?>">补充真实信息</a></li>
		<li <?php if(vip == 'apply'): ?>class="active"<?php endif; ?>><a href="<?php echo U('/user/center/apply');?>">申请成为作者</a></li>
		<li <?php if(vip == 'bank'): ?>class="active"<?php endif; ?>><a href="<?php echo U('/user/center/bank');?>">填写银行信息</a></li>
		<li <?php if(vip == 'vip'): ?>class="active"<?php endif; ?>><a href="<?php echo U('/user/center/vip');?>">升级为VIP</a></li>
	</ul>
</div>
    		</div>
    		<div class="span9">
          ...
          <h3>升级成为vip</h3>
          <form action="<?php echo U('user/center/doVip');?>" class="form-horizontal" method="post">
