...
return array(
	...
	'CHAPTER' => array(
		...
		'status' => array(
			0 => '正常',			// 三者皆可以
			1 => '关闭',			// 用户无法查看，作者无法编辑，管理员可以操作
			2 => '待审核',		// 用户无法查看，作者可以编辑，管理员可以操作
		),
	...
	'BOOK' => array( 
		...
		'status' => array(
			'00' => '正常',			// 三者皆可以操作
			'01' => '关闭',			// 作者无法编辑，前台用户无法查看，管理可以操作
			'02' => '待审核',		// 作者可以编辑，前台用户无法查看，管理可以操作
			'03' => '作者站关闭',		// 作者无法编辑，前台用户可以查看，管理可以操作
		),
