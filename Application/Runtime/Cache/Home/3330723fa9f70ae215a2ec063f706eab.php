...
<html xmlns:wb="http://open.weibo.com/wb">
    ...
    <body>
        <div id="body">
            ...
            <!-- end #header -->
            <div id="container">
                <!-- <script src="/Public/HomeStyle/js/swfobject_modified.js" type="text/javascript"></script> -->
                <div class="clearfix">
                    <div class="content_l">
                        <div class="c_detail">
                            <div style="background-color:#fff;" class="c_logo">
                                <a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
                                    <img width="190" height="190" alt="公司logo" src="/Public/HomeStyle/images/logo_default.png">
                                    <span>
                                        更换公司图片
                                        <br>
                                        190px*190px 小于5M
                            ...
                            <div id="logoShow">
                            <img src="/Public/HomeStyle/images/logo_default.png" width="190" height="190" alt="公司logo" />
                            ...
                            <div class="c_box companyName">
                                ...
                                <a target="_blank" class="applyC" href="http://www.lagou.com/c/auth.html">
                                    申请认证
                                </a>
                                <div class="clear">
                                </div>
                                <h1 title="福建平潭协创进出口贸易有限公司" class="fullname">
                                    福建平潭协创进出口贸易有限公司
                                </h1>
                                ...
                                <div class="dn" id="addLabels">
                                    <a id="changeLabels" class="change" href="javascript:void(0)">
                                        换一换
                                    </a>
                        ...
                        <div id="Product">
                            <div class="product_wrap">
                                    ...
                                    <dd>
                                        <form method="post" class="productForm">
                                            <div class="new_product">
                                                ...
                                                <input type="file" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="product_check(this,'http://www.lagou.com/c/upload.json','productNo','productShow','type','productInfos');"
                                            ...
                                            <div class="cp_intro">
                                                ...
                                                name="productUrl">
                                                <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="500" value="发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf发达发生的faf"
                                                class="s_textarea" name="productProfile">
                                ...
                                <dl class="c_product">
                                    ...
                                    <dd>
                                        <img width="380" height="220" alt="发大发" src="/Public/HomeStyle/images/product_default.png">
                                        <div class="cp_intro">
                                            <h3>
                            ...
                            <div class="profile_wrap">
                                    ...
                                    <dd>
                                        <form id="companyDesForm">
                                            <textarea placeholder="请分段详细描述公司简介、企业文化等" name="companyProfile" id="companyProfile">
                                                该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎该方法嘎嘎
                                            </textarea>
                                            <div class="word_count fr">
                                                你还可以输入
                                                <span>
                                            ...
                                            <a id="delProfile" class="btn_cancel_s" href="javascript:void(0)">
                                                取消
                                            </a>
                                        </form>
                                    </dd>
                                ...
                                <dl class="c_section">
                                    ...
                                    <dd>
                                        ...
                                        <a title="编辑公司介绍" id="editIntro" class="c_edit" href="javascript:void(0)">
                                        </a>
                                    </dd>
                                </dl>
                            </div>
                    ...
                    <div class="content_r">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a rel="nofollow" title="http://www.weimob.com" target="_blank" href="http://www.weimob.com">
                                                    http://www.weim...
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="button" style="background:none;cursor:default;border:none !important;"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" placeholder="请输入网址" value="http://www.weimob.com" name="companyUrl"
                                                    id="companyUrl">
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <dl class="c_section c_stages">
                            <dt>
                                ...
                                <a title="编辑融资阶段" class="c_edit" href="javascript:void(0)">
                                </a>
                            </dt>
                            <dd>
                                    ...
                                    <div class="member_wrap">
                                            ...
                                            <form class="memberForm">
                                                <div class="new_portrait">
                                                    ...
                                                    <div class="portraitShow">
                                                        <img width="120" height="120" src="/Public/HomeStyle/images/leader_default.png">
                                                        <span>
                                                            更换头像
                                                        </span>
                                                    </div>
                                                    <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="member_check(this,'http://www.lagou.com/c/upload.json','portraitNo','portraitShow','type','leaderInfos');"
                                        ...
                                        <div class="member_info">
                                            ...
                                            <div class="m_portrait">
                                                ...
                                                <img width="120" height="120" alt="孙泰英" src="/Public/HomeStyle/images/leader_default.png">
                                            </div>
                                            <div class="m_name">
                                                孙泰英
                                                <a target="_blank" class="weibo" href="http://weimob.weibo.com">
                                                </a>
                                            </div>
                        ...
                        <div id="Reported">
                            ...
                            <dl class="c_section c_reported">
                                <dt>
                                    ...
                                    <a title="添加报道" class="c_add" href="javascript:void(0)">
                                    </a>
                                </dt>
                                <dd>
                                    <!-- 编辑报道 -->
                                    <ul class="reset">
                                        <li>
                                            <a style="" class="article" title="随便写" target="_blank" href="http://www.baidu.com">
                                                随便写
                                            </a>
                                            <a title="编辑报道" class="c_edit dn" href="javascript:;" style="display: inline;">
                                            </a>
                                            <form class="reportForm dn">
                                                ...
                                                <span for="articleUrl" generated="true" class="error" style="display: none;">
                                                    请输入有效的文章链接
                                                </span>
                                                <input type="submit" value="保存" class="btn_small">
                                                <a class="btn_cancel_s report_delete" href="javascript:;">
                                                    删除
                                                </a>
                                    ...
                                    <div class="addnew_right reported_info dn">
                                        ...
                                        便于求职者了解公司！
                                        <br>
                                        <a class="report_edit" href="javascript:void(0)">
                                            +添加报道
                                        </a>
                                    </div>
                                    <ul class="newReport dn">
                                        <li>
                                            <a style="display:none;" class="article" title="" target="_blank">
                                            </a>
                                            <a title="编辑报道" class="c_edit dn" href="javascript:;">
                                            </a>
                                            <form class="reportForm">
                                                <input type="text" placeholder="请输入文章标题" value="" name="articleTitle">
                                                <input type="text" placeholder="请输入文章链接" value="" name="articleUrl">
                                                <input type="submit" value="保存" class="btn_small">
                                                <a class="btn_cancel_s report_cancel" href="javascript:;">
                                                    取消
                                                </a>
                ...
                <div style="display:none;">
                    <div style="width:650px;height:470px;" class="popup" id="logoUploader">
                        <object width="650" height="470" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                        id="FlashID">
                            <param value="../../flash/avatar.swf?url=http://www.lagou.com/cd/saveProfileLogo.json"
                            name="movie">
                            ...
                            <!--[if !IE]>-->
                                <object width="650" height="470" data="../../flash/avatar.swf?url=http://www.lagou.com/cd/saveProfileLogo.json"
                                ...
                                <div>
                                    ...
                                    <p>
                                        <a href="http://www.adobe.com/go/getflashplayer">
                                            <img width="112" height="33" src="/Public/HomeStyle/images/get_flash_player.gif" alt="获取 Adobe Flash Player">
                                        </a>
                                    </p>
                                </div>
                                <!--[if !IE]>-->
                ...
                <!------------------------------------- end ----------------------------------------->
                <script src="/Public/HomeStyle/js/company.min.js" type="text/javascript">
                </script>
                <script>
                    var avatar = {};
