...
<html> 
                ...
                <div class="content_mid">
                    <dl class="c_section c_section_mid">
                        ...
                        <dd id="step2Form">
                            ...
                            <img width="668" height="56" class="c_steps" alt="第二步" src="/Public/HomeStyle/images/step2.png">
                            <h3>
                                已添加标签
                            </h3>
                            ...
                            <div id="box_labels">
                                <dl>
                                    ...
                                    <dd>
                                        <ul class="reset">
                                            <?php if(is_array($tag1)): foreach($tag1 as $key=>$val1): ?><li><?php echo ($val1["name"]); ?></li><?php endforeach; endif; ?>
                                        </ul>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        <ul class="reset">
                                            <?php if(is_array($tag2)): foreach($tag2 as $key=>$val2): ?><li><?php echo ($val2["name"]); ?></li><?php endforeach; endif; ?>
                                        </ul>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        <ul class="reset">
                                            <?php if(is_array($tag3)): foreach($tag3 as $key=>$val3): ?><li><?php echo ($val3["name"]); ?></li><?php endforeach; endif; ?>
                                        </ul>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        <ul class="reset">
                                            <?php if(is_array($tag4)): foreach($tag4 as $key=>$val4): ?><li><?php echo ($val4["name"]); ?></li><?php endforeach; endif; ?>
                                        </ul>
                                    </dd>
                                </dl>
                            </div>
                            ...
                            <a class="btn_cancel fr" href="<?php echo U('/Home/CompanyReg/step6');?>">
                                跳过
                            </a>
                        </dd>
                    </dl>
    ...
    <div class="wrapper">
        ...
        <script src="/Public/HomeStyle/js/step2.min.js" type="text/javascript"></script>
